...
//    }
//
//    def remove[T >: A](elem: T)(implicit ordering: Ordering[T]): Tree[T] = {
//      println(s"Removing $elem; before: $this")
//      val ret = this match {
...
//        case n: Node[T] => n.removeNode(elem); n
//      }
...
//
//    def removeNode(elem: A)(implicit ordering: Ordering[A]): Unit = find(elem) match {
//      case None => throw new NoSuchElementException
//      case Some(n) => n.removeNode()
//    }
//
//
//    def removeNode(): Unit =
